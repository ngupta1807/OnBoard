 ...
 */
public class ServiceHandlerInBack extends AsyncTask<String, Void, String> {
    ...
    public ServiceHandlerInBack(Context context, String method, AsyncTaskCompleteListener callback, HashMap<String, String> param) {
