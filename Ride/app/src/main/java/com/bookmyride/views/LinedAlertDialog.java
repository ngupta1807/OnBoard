...
public class LinedAlertDialog {
    ...
    public LinedAlertDialog(Context context, boolean show, boolean cancellable) {
        ...
        view = View.inflate(mContext, R.layout.lined_alert_dialog, null);
