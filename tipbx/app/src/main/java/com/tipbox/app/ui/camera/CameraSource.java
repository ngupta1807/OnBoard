 ...
 * possible, while at the same zd_time minimizing lag.  As such, frames may be dropped if the detector
...
public class CameraSource {
    ...
    public interface ShutterCallback {
         ...
         * This may be some zd_time after the photo was triggered, but some zd_time before the actual data
         * is available.
         */
        void onShutter();
    }
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    // executing at the same zd_time (i.e., which would happen if we called start too
                    // quickly after stop).
    ...
    private class FrameProcessingRunnable implements Runnable {
         ...
         * pausing.
         * <p/>
         * If detection takes longer than the zd_time in between new frames from the camera, this will
         * mean that this loop will run without ever waiting on a frame, avoiding any context
         * switching or frame acquisition zd_time latency.
         * <p/>
         * If you find that this is using more CPU than you'd like, you should probably decrease the
         * FPS setting above to allow for some idle zd_time in between frames.
         */
        @Override
        public void run() {
            Frame outputFrame;
