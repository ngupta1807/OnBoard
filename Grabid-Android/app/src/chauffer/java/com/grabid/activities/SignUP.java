...
public class SignUP extends AppCompatActivity implements
    ...
    TextView title, otpTxt, done, mDoB;
    ImageView nav;
    ...
    private void init() {
        ...
        cCode = (ImageView) findViewById(R.id.cc);
        cCode.setOnClickListener(this);
        mcClinear = (LinearLayout) findViewById(R.id.cclinear);
        ...
        countrypicker.setOnItemSelectedListener(SignUP.this);
    ...
    protected void onStart() {
        ...
        ClickableSpan termsOfServicesClick = new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(Color.parseColor("#C09B30"));
            }
        };
    ...
    private boolean isValid() {
        ...
        if (firstName.getText().toString().trim().length() == 0) {
            ...
            showMessage(getResources().getString(R.string.passwordlength));
            return false;
