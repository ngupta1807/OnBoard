...
public class VehicleListProfileCompany extends AppCompatActivity {
    View view;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final CategoryAdapter catAdapter = new CategoryAdapter(VehicleListProfileCompany.this);
    ...
    private void showMessage(String message) {
        AlertManager.messageDialog(VehicleListProfileCompany.this, "Alert!", message);
    }
