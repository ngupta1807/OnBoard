...
public class SessionManager {
    ...
    public void saveUserDate(String userID, String userName, String email, String image, String token,
                             ...
                             String vehicleInfo, String sRating, String dRating, String ChargeMe, String Payme, String adminapproval, String emailverified, String userpaymentmode, boolean IsLogin) {
        ...
        editor.putString(Keys.USER_PAYMENT_MODES, userpaymentmode);
    ...
    public void saveShipmentAddress(String title, String suitablevehicle, String puContact, String puMobile,
        ...
        editor.putString(Keys.SUITABLE_VEHICLE, suitablevehicle);
    ...
    public ShipmentAddress getShipmentAddress() {
        ...
        address.setSuitablevehicle(pref.getString(Keys.SUITABLE_VEHICLE, ""));
    ...
    public void saveShipMent(String delivery, String deliveryType, String qty, String weight,
                             ...
                             String breed, String vaccination, String subsubid,
                             String deliveryItem) {
    ...
    public void saveJob(String JobType, String Asap, String RoundTrip, String totalpassenger, String mPaymentMode) {
        editor.putString(Keys.JOB_TYPE, JobType);
        editor.putString(Keys.ASAP, Asap);
        editor.putString(Keys.ROUNDTRIP, RoundTrip);
        editor.putString(Keys.TOTALPASSENGER, totalpassenger);
        editor.putString(Keys.PAYMENT_MODE, mPaymentMode);
        editor.commit();
    }

    public Jobs getJobs() {
        Jobs jobs = new Jobs();
        jobs.setJobType(pref.getString(Keys.JOB_TYPE, ""));
        jobs.setAsap(pref.getString(Keys.ASAP, ""));
        jobs.setRoundTrip(pref.getString(Keys.ROUNDTRIP, ""));
        jobs.setTotalqty(pref.getString(Keys.TOTALPASSENGER, ""));
        jobs.setPaymentmode(pref.getString(Keys.PAYMENT_MODE, ""));
        return jobs;
    }
    ...
    public CompanyInfo getCompanyInfo() {
        ...
        try {
            ...
            info.setCompany_logo(data.getString(Keys.COMPANY_LOGO));
    ...
    public DriverInfo getDriverInfo() {
        ...
        try {
            ...
            data.setCertificate_image(info.getString(Keys.CERTIFICATE_IMAGE));
            data.setCertificate_number(info.getString(Keys.CERTIFICATE_NO));
            data.setCertificate_valid_till(info.getString(Keys.CERTIFICATE_VALIDATE));
    ...
    public UserInfo getUserDetails() {
        ...
        try {
            ...
            user.setUser_payment_modes(pref.getString(Keys.USER_PAYMENT_MODES, ""));
...
//            user.setVerifiedStatus(info.getString(Keys.VERIFIED_STATUS));
    ...
    public String getIP() {
        //return pref.getString(Keys.KEY_IP, "www.grabid.com.au");
