...
public class HomeMap extends Fragment implements View.OnClickListener,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
      ...
      /*  GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                ...
                .build();*/
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestId().requestEmail().requestIdToken("592598835178-8muri61ncs711ka0259ukepbklncqgkh.apps.googleusercontent.com")
                .build();
                ...
                try {
                    if (userInfo.getIsprofileCompleted().equals("0"))
                        ...
                        //    HomeActivity.edit.setBackgroundResource(R.drawable.location_icon);
                            HomeActivity.edit.setBackgroundResource(R.drawable.home_left);
...
*/
    ...
    private void showProfileDialog() {
        ...
        builder.setMessage(getActivity().getString(R.string.profileactivate));
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            ...
            if (outJson.getInt(Config.STATUS) == APIStatus.SUCCESS) {
                if (type == 1) {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        homeData.setAsap((obj.get(Config.ASAP).toString().equals("1")) ? true : false);
                        homeData.setRoundTrip((obj.get(Config.ROUNDTRIP).toString().equals("1")) ? true : false);
                        homeData.setItemtype(obj.getString(Config.ITEMTYPE));
                        ...
                        homeData.setCompanyLogo(obj.getString(Keys.COMPANY_LOGO));
                        try {
    ...
    public void ChangeUi(String id, String oldUi) {
        ...
        switch (id) {
            case "1": {
                freight.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.appliances_active, 0, 0);
            ...
            case "2": {
                appliance.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.freight_active, 0, 0);
                appliance.setTextColor(getResources().getColor(R.color.filer_text_color_selected));
//                appliance.setBackgroundColor(getResources().getColor(R.color.black));
        ...
        if (!oldUi.contentEquals("")) {
            if (oldUi.contentEquals("1")) {
                freight.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.appliances, 0, 0);
                ...
                appliance.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.freight, 0, 0);
    ...
    private void expand() {
        ...
        upDown.setImageResource((R.drawable.expand_arrow));
        mAnimator.start();
    }
...
//            if (googleMap != null)
            ...
            for (int i = 1; i <= data.size(); i++) {
                ...
                if ( homeData.getPickUpState() != null && !homeData.getPickUpState().equals("null") && !homeData.getPickUpState().equals("<null>")){
                    if (homeData.getPick_up_city()!= null) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), permissionsRequired[0])
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Toast.makeText(getActivity(), "Go to Permissions to Grant Location Permission", Toast.LENGTH_LONG).show();
                        }
                    });
                    builder.setNegativeButton("Don’t Allow", new DialogInterface.OnClickListener() {
                        @Override
