...
/**
 * Created by graycell on 31/5/17.
 */

public class BidderInfo extends Fragment implements View.OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        init(view);
        if (getArguments().containsKey("bidderid"))
            shipperID = getArguments().getString("bidderid");
        getShipperInfo();
        return view;
    }
    ...
    private void appendData(com.grabid.models.Shipper shipper) {
        ...
        shipperRating.setRating(Float.valueOf(shipper.getShipperRating()));
    ...
    private void handleResponse(String result) {
        try {
            ...
            if (outJson.getInt(Config.STATUS) == APIStatus.SUCCESS) {
                com.grabid.models.Shipper shipper = new com.grabid.models.Shipper();
