...
public class SignIn extends AppCompatActivity implements AsyncTaskCompleteListener,
    ...
    private void init() {
       ...
       /* GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestId().requestEmail().requestIdToken("961148736047-iijql96url6vjpr5u4emou058fjac3ud.apps.googleusercontent.com")
                .build();*/
    ...
    private void UserData(JSONObject outterJson) {
        try {
            ...
            new SessionManager(this).saveUserDate(UserInfo.getString(Keys.KEY_ID),
                    ...
                    company.toString(), vehicle.toString(), sRating, dRating, dataObj.optString(Keys.CREDIT_CARD), dataObj.optString(Keys.BANK_DETAIL), AdminApprovalStatus, EmailVerified, true);
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            if (ActivityCompat.checkSelfPermission(SignIn.this, permissionsRequired[0]) != PackageManager.PERMISSION_GRANTED
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(SignIn.this, permissionsRequired[0])
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SignIn.this);
                    builder.setTitle("GRABiD Logistics would like to access your Location.");
                    builder.setMessage("GRABiD Logistics needs Location permissions.");
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
