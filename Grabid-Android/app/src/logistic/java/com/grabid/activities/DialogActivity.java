...
public class DialogActivity extends Activity implements AsyncTaskCompleteListener {
    ...
    private void cancelDelivery(String deliveryID) {
        ...
        if (Internet.hasInternet(DialogActivity.this)) {
            RestAPICall mobileAPI = new RestAPICall(DialogActivity.this, HTTPMethods.POST, this, params);
    ...
    public void handleResponse(String result) {
        try {
            ...
            if (outJson.getInt(Config.STATUS) == APIStatus.SUCCESS) {
                messageDialog(DialogActivity.this, "Success!", "Your delivery has been cancelled successfully.", true);
            } else {
