...
public class Search extends Fragment implements View.OnClickListener, AsyncTaskCompleteListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        deliveryTypeID = srcCity = transferTypeId = srcState = srcCountry = destCity = destState = destCountry = "";
        init(view);
        getDeliveryTypes();
        return view;
    }
    ...
    private void init(View view) {
        ...
        mTransferType = (TextView) view.findViewById(R.id.delivery_type);
    ...
    private void searchDeliveries() {
        ...
        if (!deliveryTypeID.equals(""))
            url = url + "&delivery_type_id=" + deliveryTypeID;
