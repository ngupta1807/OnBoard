...
public class MultipartUtility {
	...
	public MultipartUtility(String requestURL, String charset, Context Con)
		...
		httpConn.setConnectTimeout(3000000);
		httpConn.setReadTimeout(3000000);
		httpConn.setRequestProperty("Content-Type",
				"multipart/form-data; boundary=" + boundary);
		httpConn.setRequestProperty("access-token",
				spm.getStringValues(Constants.Token));
		httpConn.setRequestProperty("client",
				spm.getStringValues(Constants.Client));
		httpConn.setRequestProperty("expiry",
				spm.getStringValues(Constants.Expiry));
		httpConn.setRequestProperty("token-type", "Bearer");
		httpConn.setRequestProperty("uid", spm.getStringValues(Constants.Uid));
